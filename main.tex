...
動的オブジェクトは，3D Gaussian Splattingの学習過程において，複数フレーム間で一貫性のない再構成誤差を示す領域として検出される．
...
映り込みに対応した自由視点画像生成技術の先行研究\cite{tang2025dronesplat3dgaussiansplatting}においては，動的物体を学習から削除している．一方
