...
本手法では，3DGS\cite{kerbl3Dgaussians}の学習において，動的オブジェクトと静止オブジェクトを区別して不要物を同定する．
...
このフローにより，動的オブジェクトと静止オブジェクトの両方を効果的に除去し，高品質な3Dシーン再構成を実現する（図\ref{fig:overview}）．

\vspace{10pt}
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\columnwidth]{img-for-paper/overview.png}
  \caption{提案手法の全体フロー}
  \label{fig:overview}
\end{figure}
\vspace{10pt}
